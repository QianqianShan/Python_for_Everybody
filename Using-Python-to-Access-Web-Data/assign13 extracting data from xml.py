...
# Actual data: http://python-data.dr-chuck.net/comments_314602.xml (Sum ends with 45)
...
# But since the nesting of the elements in our data is different than
# the data we are parsing in that sample code you will have to make real changes to the code.
# To make the code a little simpler, you can use an XPath
# selector string to look through the entire tree of XML
...
#  You could also work from the top of the XML down
